export default function TestimonialsSection() {
  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-rose-50/30 to-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Result Badge */}
              <div className="mb-6">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-rose-50 to-pink-50 rounded-full">
                  <svg
              ...
              {/* Author Info */}
              <div className="flex items-center gap-3 pt-6 border-t border-rose-100">
                <div className="w-12 h-12 bg-gradient-to-br from-rose-200 to-pink-200 rounded-full flex items-center justify-center text-rose-700 font-bold text-lg">
        ...
        {/* Bottom Stats */}
        <div className="grid md:grid-cols-4 gap-8 pt-12 border-t border-rose-200">
          ...
          <div className="text-center">
            <div className="text-4xl font-bold text-rose-600 mb-2">30 Days</div>
            <div className="text-sm text-gray-600">
              Average time to feel results
            </div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-rose-600 mb-2">12K+</div>
            <div className="text-sm text-gray-600">Verified 5-star reviews</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-rose-600 mb-2">90 Days</div>
